...
# Настройки HTTPS
SECURE_SSL_REDIRECT = False  # Включает перенаправление с HTTP на HTTPS
SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')  # Если ваш бэкенд находится за прокси



# # Опционально, настройте куки для HTTPS
